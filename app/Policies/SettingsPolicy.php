...
class SettingsPolicy
{
     ...
     */
    public function view(User $user, Setting $settings): bool
    {
     ...
     */
    public function update(User $user, Setting $settings): bool
    {
     ...
     */
    public function delete(User $user, Setting $settings): bool
    {
     ...
     */
    public function forceDelete(User $user, Setting $settings): bool
    {
     ...
     */
    public function restore(User $user, Setting $settings): bool
    {
     ...
     */
    public function replicate(User $user, Setting $settings): bool
    {
